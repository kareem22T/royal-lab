...
@section("title", "Consultations - Create")
@section("loading_txt", "Create")

@section("content")
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Create Consultation</h1>
    ...
    <div class="d-flex justify-content-between" style="gap: 16px">
        <div class="w-100">
            <div class="form-group w-100">
                ...
                <input type="text" class="form-control" id="name"  placeholder="Consultation Name" v-model="name">
            </div>
            <div class="form-group w-100">
...
createApp({
    ...
    methods: {
        ...
        async create() {
            ...
            try {
                const response = await axios.post(`{{ route("admin.consultations.create") }}`, {
                    name: this.name,

...
@section("loading_txt", __("consultations.loading_txt"))

@section("content")
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ __("consultations.create_consultation") }}</h1>
...
<div class="card p-3 mb-3" id="consultations_wrapper">
    ...
    <div class="form-group">
        <button class="btn btn-success w-25" @click="create">{{ __("consultations.create_button") }}</button>
    </div>
</div>

...
@php
    $appointments = App\Models\Appointment::latest()->with("user")->where("status", 0)->paginate(15);

@endphp

@section("content")
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">@lang('appointments.canceled_appointments')</h1>
</div>

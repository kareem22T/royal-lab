...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Create Doctor</h1>
     ...
     <table class="table" v-if="specializations && specializations.length > 0">
        ...
        <tbody>
          <tr v-for="specialization, index in specializations" :key="index">
            <td>
                <input type="text" name="size" id="size" class="form-control" placeholder="Specialization Name" v-model="specializations[index]['name']" required>
            </td>
            <td>
                <input type="text" name="Flavour" id="Flavour" class="form-control" placeholder="Specialization Name ar" v-model="specializations[index]['name_ar']" required>
            </td>
            <td>

...
@section("content")
    <div class="card p-4">
        ...
        <div class="btns d-flex justify-content-center align-items-center">
            <a href="{{route('admin.medical_consultations.medical_consultation.details', ['id' => $medical_consultation->id])}}" class="btn btn-info w-25 m-3">Show Consultation</a>
            <a href="{{route('admin.medical_consultations.show.all')}}" class="btn btn-secondary w-25 m-3">Back To List</a>
        </div>
    </div>
@endSection

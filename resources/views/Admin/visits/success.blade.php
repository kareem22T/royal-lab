...
@section("content")
    <div class="card p-4">
        ...
        <div class="btns d-flex justify-content-center align-items-center">
            <a href="{{route('admin.visits.visit.details', ['id' => $visit->id])}}" class="btn btn-info w-25 m-3">Show Visit</a>
            <a href="{{route('admin.visits.show.all')}}" class="btn btn-secondary w-25 m-3">Back To List</a>
        </div>
    </div>
@endSection

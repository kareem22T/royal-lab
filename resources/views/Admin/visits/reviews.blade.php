...
@section("title", "Visits - Under Review")

@php
    $visits = App\Models\Visit::latest()->with("user")->where("status", 1)->paginate(15);
@endphp

@section("content")
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Visits - Under Review</h1>
</div>

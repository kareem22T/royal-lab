...
<div class="card p-3 mb-3" id="cities_wrapper">
    <div class="card-header mb-3">
        <h3 class="text-danger text-center mb-0">Are you sure you want to delete this City?</h3>
    </div>
    <div class="d-flex justify-content-between" style="gap: 16px">
        <div class="w-100">
            <div class="form-group w-100">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control" id="name" disabled  placeholder="City Name" v-model="name">
            </div>
        </div>
    </div>
    <div class="form-group w-100 d-flex justify-content-center" style="gap: 16px">
        <a href="{{ route("admin.cities.show") }}" class="btn btn-secondary w-25">Cancel</a>
...
createApp({
    data() {
        return {
            ...
            thumbnail: null,
            thumbnail_path: '{{ $city->thumbnail_path }}',
        }
    },
    methods: {

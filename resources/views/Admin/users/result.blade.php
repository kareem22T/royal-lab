...
<div class="card p-3 mb-3" id="Results_wrapper">
        ...
        <div class="w-100">
            ...
            <div class="form-group w-100">
                ...
                <div class="d-flex" style="gap: 16px">
                    ...
                    <a :href="file_path" v-if="file_path" :download="'reslut_' + '{{$result->id}}'" style="white-space: nowrap" class="btn btn-primary">Download Old</a>
                </div>
            </div>
        </div>
    ...
    <div class="form-group">
        <button class="btn btn-success w-25" @click="create">Update</button>
    </div>
</div>
...
createApp({
    data() {
        return {
            ...
            name_ar: "{{ $result->service_name_ar }}",
    ...
    methods: {
        ...
        async create() {
            ...
            try {
                const response = await axios.post(`{{ route("admin.result.update") }}`, {
